...
<div class="auth-container">
    ...
    <div class="auth-hero">
        ...
        <div class="hero-content">
            <h1>Streamline your library workspace.</h1>
            <p>Manage books, process borrowings, and oversee member profiles seamlessly in one place.</p>
            
            <ul class="hero-features">
                <li><i class="fa-solid fa-check"></i> Real-time inventory tracking</li>
                <li><i class="fa-solid fa-check"></i> Automated borrowing records</li>
                <li><i class="fa-solid fa-check"></i> Instant member management</li>
            </ul>
        </div>
    ...
    <div class="auth-form-wrapper">
        ...
        <form method="POST" action="login.php">
            ...
            <button type="submit" class="btn-submit">
                Log In <i class="fa-solid fa-arrow-right" style="margin-left: 0.4rem;"></i>
            </button>
        </form>
